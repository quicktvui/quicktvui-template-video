...
import {useMediaDataSource} from "../../../datasource/useApi";
import {createESPlayerMediaItemInterceptor} from "../player/ESPlayerMediaItemInterceptor";
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const playerViewList = [markRaw(ESMediaPlayerView)]
    ...
    const interceptor = createESPlayerMediaItemInterceptor(mediaDataSource)
    ...
    function addMediaItemList(page: number, mediaList: Array<IMedia>) {
      //播放器数据
      const mediaItemList = buildMediaItemList(page, mediaList, interceptor)
